...
for filename in *_APPLICATIONS.txt; 
   do
     sort "$filename" | grep -v "Security Update" | grep -v "Service Pack" | grep -v "Hotfix" | grep -v "Viewer" | grep -v "Update for " >> APPL.txt
     echo "fim" >> APPL.txt
   done
...
grep -E "Microsoft Office\s?(Professional|Premium|Standard){1}\s?.+\s*[0-9]{0,4}\s*$" APPL.txt | cut -d ";" -f 1 >> MS_Office.txt1
grep -E "Microsoft (Office)?\s*Project\s*(Professional|Premium|Standard)?\s*(MUI)?\s*(.*)[0-9]{0,4}\s*$" APPL.txt | cut -d ";" -f 1 >> MS_Project.txt1
grep -E "Microsoft (Office)?\s*PowerPoint\s*(Professional|Premium|Standard)?\s*(MUI)?\s*(.*)[0-9]{0,4}\s*$" APPL.txt | cut -d ";" -f 1 >> MS_Office.txt1
grep -E "Microsoft (Office)?\s*Access\s*(Professional|Premium|Standard)?\s*(MUI)?\s*(.*)[0-9]{0,4}\s*$" APPL.txt | cut -d ";" -f 1 >> MS_Office.txt1
grep -E "Microsoft (Office)?\s*Excel\s*(Professional|Premium|Standard)?\s*(MUI)?\s*(.*)[0-9]{0,4}\s*$" APPL.txt | cut -d ";" -f 1 >> MS_Office.txt1
grep -E "Microsoft (Office)?\s*Visio\s*(Professional|Premium|Standard)?\s*(MUI)?\s*(.*)[0-9]{0,4}\s*$" APPL.txt | cut -d ";" -f 1 >> MS_Visio.txt1
grep -E "Microsoft (Office)?\s*Word\s*(Professional|Premium|Standard)?\s*(MUI)?\s*(.*)[0-9]{0,4}\s*$" APPL.txt | cut -d ";" -f 1 >> MS_Office.txt1
grep -E "Microsoft SQL Server [0-9]{4} [R2]*$" APPL.txt | cut -d ";" -f 1 >> MS_SQL.txt1
grep -E "Microsoft Visual C++*$" APPL.txt | cut -d ";" -f 1 >> MS_VS.txt1
grep -E "Microsoft SQL Server [0-9]{0,4}\s?.*" APPL.txt | cut -d ";" -f 1 >> MS_SQL.txt1
grep -E "SQL Server [0-9]{0,4}\s?.*" APPL.txt | cut -d ";" -f 1 >> MS_SQL.txt1
grep -E "Microsoft Visual Studio [0-9]{0,4}\s*(Professional|Enterprise|Premium|Ultimate){1}\s?.*" APPL.txt | cut -d ";" -f 1 >> MS_VS.txt1
grep -E "Microsoft Visual Studio (Professional|Enterprise|Premium|Ultimate){1}\s*[0-9]{4}\s?.*" APPL.txt | cut -d ";" -f 1 >> MS_VS.txt1
grep -E "Microsoft Visual Studio Team Foundation Server [0-9]{0,4}\s?.*" APPL.txt | cut -d ";" -f 1 >> MS_VS.txt1
