...
class MailingsControllerTest < ActionController::TestCase
  ...
  test "should create mailing" do
    assert_difference('Mailing.count') do
      post :create, mailing: { body: @mailing.body, cc: @mailing.cc, subject: @mailing.subject, tag: @mailing.tag, to: @mailing.to }
    end
  ...
  test "should update mailing" do
    put :update, id: @mailing, mailing: { body: @mailing.body, cc: @mailing.cc, subject: @mailing.subject, tag: @mailing.tag, to: @mailing.to }
    assert_redirected_to mailing_path(assigns(:mailing))
  end
