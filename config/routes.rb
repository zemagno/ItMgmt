...
ItMgmt::Application.routes.draw do
  ...
  match 'relatorio_publico/:id', to: "relatorio#index", as: "relatorio", via: [:get, :post]
  match 'relatorio/:id', to: "relatorio#index_publico", as: "relatorio_publico", via: [:get, :post]
