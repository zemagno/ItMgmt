...
Rails.application.config.assets.precompile += %w( tab_dicdados.js suporte-saas.js jquery-ui.css chavecis.css CMDBstyle.css scaffold.css jquery-ui-timepicker-addon.css jquery.datetimepicker.css bootstrap.min.css itam.css tela_login.css)
...
Rails.application.config.assets.precompile += %w( cadrelatorio-painel-0.css )
