...
Rails.application.config.assets.precompile += %w( jquery.js jquery-ujs.js application.js jquery.datetimepicker.js jquery.min.js jquery-ui.min.js utils.js bootstrap.min.js)
