...
begin
  ...
  tipoci.dicdados.create({nome: "Operadora",tipoci_id: tipoci.id,ordem: "21",url: "/cis/%s",descricao: "",valores: ",Level3,GVT,Embratel,Algar,CriareNet,MegaTelecom,Mundivox,Oi,TecTreina,Telmex,Tesa,Unifor,Vivo,Copel,Hotlink,Speedy",apelido: "fornecedor",tipo: "",regex: "",mandatorio: "false",tooltip: "",comentarios: ""})
  ...
  tipoci.dicdados.create({nome: "Nota",tipoci_id: tipoci.id,ordem: "85",url: "/notes/%s",descricao: "",valores: "",apelido: "Nota",tipo: "",regex: "",mandatorio: "",tooltip: "",comentarios: ""})
